...
respectively form the hypotenuse, greater and smaller legs of a right
triangle then their circumcircles are congruent (Figure 2).

Now, the the proof for this as given by Euclid is not entirely obvious
and, at least to us, it is unclear if he even gave a complete proof for
