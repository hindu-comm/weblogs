...
![z^m+1=0](https://s0.wp.com/latex.php?latex=z%5Em%2B1%3D0&bg=ffffff&fg=333333&s=0&c=20201002),
where integer
![m=3,4,5...](https://s0.wp.com/latex.php?latex=m%3D3%2C4%2C5...&bg=ffffff&fg=333333&s=0&c=20201002)

The roots of this equation, ![z_j: z_1, z_2...
z_m](https://s0.wp.com/latex.php?latex=z_j%3A+z_1%2C+z_2...+z_m&bg=ffffff&fg=333333&s=0&c=20201002),
define the vertices of a
...
we get an equilateral triangle defined by the roots ![z_1=
\\tfrac{1}{2}+\\tfrac{\\sqrt{3}i}{2}, z_2= -1, z_3=
\\tfrac{1}{2}-\\tfrac{\\sqrt{3}i}{2}](https://s0.wp.com/latex.php?latex=z_1%3D+%5Ctfrac%7B1%7D%7B2%7D%2B%5Ctfrac%7B%5Csqrt%7B3%7Di%7D%7B2%7D%2C+z_2%3D+-1%2C+z_3%3D+%5Ctfrac%7B1%7D%7B2%7D-%5Ctfrac%7B%5Csqrt%7B3%7Di%7D%7B2%7D&bg=ffffff&fg=333333&s=0&c=20201002).
...
1](https://s0.wp.com/latex.php?latex=0%3Cr%5Cle+1&bg=ffffff&fg=333333&s=0&c=20201002).
If
...
[![chg06_1](https://manasataramgini.files.wordpress.com/2019/03/chg06_1.png?w=629&h=629)](https://manasataramgini.files.wordpress.com/2019/03/chg06_1.png)Figure
1

For other ![m,
r](https://s0.wp.com/latex.php?latex=m%2C+r&bg=ffffff&fg=333333&s=0&c=20201002)
we get chaotic maps and for particular values of ![m,
r](https://s0.wp.com/latex.php?latex=m%2C+r&bg=ffffff&fg=333333&s=0&c=20201002)
we get attractors with a fractal structure. Thus, the Sierpinski
triangle is obtained with ![m=3,
r=\\tfrac{1}{2}](https://s0.wp.com/latex.php?latex=m%3D3%2C+r%3D%5Ctfrac%7B1%7D%7B2%7D&bg=ffffff&fg=333333&s=0&c=20201002).
This fills the triangle defined by ![z_1, z_2,
z_3](https://s0.wp.com/latex.php?latex=z_1%2C+z_2%2C+z_3&bg=ffffff&fg=333333&s=0&c=20201002)
...
For ![m=4,
r=\\tfrac{1}{1+\\sqrt{2}}](https://s0.wp.com/latex.php?latex=m%3D4%2C+r%3D%5Ctfrac%7B1%7D%7B1%2B%5Csqrt%7B2%7D%7D&bg=ffffff&fg=333333&s=0&c=20201002)
we get the fractal street block (Figure 3).
...
For ![m=5,
r=1-\\tfrac{1}{\\phi}](https://s0.wp.com/latex.php?latex=m%3D5%2C+r%3D1-%5Ctfrac%7B1%7D%7B%5Cphi%7D&bg=ffffff&fg=333333&s=0&c=20201002)
(where
...
the Golden Ratio) we get the fractal pentagons surrounding the interior
penta-flake (Figure 4).
...
For ![m=6,
r=\\tfrac{1}{3}](https://s0.wp.com/latex.php?latex=m%3D6%2C+r%3D%5Ctfrac%7B1%7D%7B3%7D&bg=ffffff&fg=333333&s=0&c=20201002)
we get the fractal hexagons surrounding the interior Koch’s snowflake
(Figure 5).
...
For ![m=7,
r=\\tfrac{1}{S}](https://s0.wp.com/latex.php?latex=m%3D7%2C+r%3D%5Ctfrac%7B1%7D%7BS%7D&bg=ffffff&fg=333333&s=0&c=20201002)
(where
...
the Silver constant. The [Silver
...
we get the fractal heptagon necklace surrounding the interior
hepta-flake (Figure 6).
...
[![chg_12_wheel_time](https://manasataramgini.files.wordpress.com/2019/03/chg_12_wheel_time.png?w=654&h=654)](https://manasataramgini.files.wordpress.com/2019/03/chg_12_wheel_time.png)Figure
12
...
yields the overlapping attractor (Figure 12). We have been able to
obtain closed forms for the
![r](https://s0.wp.com/latex.php?latex=r&bg=ffffff&fg=333333&s=0&c=20201002)
