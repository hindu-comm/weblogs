...
![z'](https://s0.wp.com/latex.php?latex=z%27&bg=ffffff&fg=333333&s=0&c=20201002)
by a segment then the envelope of those segments defines an epicycloid
in the unit circle with
![n-1](https://s0.wp.com/latex.php?latex=n-1&bg=ffffff&fg=333333&s=0&c=20201002)
cusps. Thus, for squaring we get a cardioid, for cubing a nephroid, for
power 4 a tricuspid epicycloid and so on.
...
![Mandelbrot_zcubed](https://manasataramgini.files.wordpress.com/2017/04/mandelbrot_zcubed.png?w=640)Figure
...
\\sqrt{ab}](https://s0.wp.com/latex.php?latex=%5Cpm+%5Csqrt%7Bab%7D&bg=ffffff&fg=333333&s=0&c=20201002)
and can be visualized as the projection of the great circles of a sphere
on to a plane.
...
a=1](https://s0.wp.com/latex.php?latex=c%3D1%2B0i%2C+a%3D1&bg=ffffff&fg=333333&s=0&c=20201002)
— a unit circle passing through origin. If we deploy the following map
on it ![z'\\mapsto
\\sqrt{z}](https://s0.wp.com/latex.php?latex=z%27%5Cmapsto+%5Csqrt%7Bz%7D&bg=ffffff&fg=333333&s=0&c=20201002),
the square root function being two-valued creates a ![1\\mapsto
2](https://s0.wp.com/latex.php?latex=1%5Cmapsto+2&bg=ffffff&fg=333333&s=0&c=20201002)
mapping. This results in the bilobed lemniscate discovered by Jakob
Bernoulli which crosses over at origin and with foci at ![\\pm
1](https://s0.wp.com/latex.php?latex=%5Cpm+1&bg=ffffff&fg=333333&s=0&c=20201002).
If we instead deploy the squaring map ![z'\\mapsto
z^2](https://s0.wp.com/latex.php?latex=z%27%5Cmapsto+z%5E2&bg=ffffff&fg=333333&s=0&c=20201002)
on this circle we end up with a cardioid. Instead of the above unit
circle consider a vertical line passing through
...
If we similarly apply the square root operator on it gets mapped onto to
a double branched curve the rectangular hyperbola. On the other hand
application of the squaring operator on this vertical line bends it into
a left facing parabola. Thus, the ellipse, hyperbola and parabola can be
seen as secondary conics generated from the line and circle.

![circle_cassinian_map](https://manasataramgini.files.wordpress.com/2017/04/circle_cassinian_map.png?w=640)Figure
4

Now if the circle has
![a\<1](https://s0.wp.com/latex.php?latex=a%3C1&bg=ffffff&fg=333333&s=0&c=20201002)
then the same square root map creates two disjoint lobes which are the
ovals discovered by the astronomer Cassini, whereas the square map
creates a limacon. Similarly if
![a>1](https://s0.wp.com/latex.php?latex=a%3E1&bg=ffffff&fg=333333&s=0&c=20201002)
the mapping merges the lobes into continuous Cassinian curves and
limacons with an internal lobe.
...
“limited” set of special points (e.g. the cusp of an epicycloid). A few
years after his death his brilliant successor Bernhard Riemann
...
\\pi)}; \\; a,n \\in
\\mathbb{N}\_1](https://s0.wp.com/latex.php?latex=y%3D%5Cdisplaystyle+%5Csum_%7Bn%3D1%7D%5E%5Cinfty+%5Cdfrac%7B%5Csin%28n%5Ea+%5Cpi+x%29%7D%7B%28n%5Ea+%5Cpi%29%7D%3B+%5C%3B+a%2Cn+%5Cin+%5Cmathbb%7BN%7D_1&bg=ffffff&fg=333333&s=0&c=20201002)  
Here
![a](https://s0.wp.com/latex.php?latex=a&bg=ffffff&fg=333333&s=0&c=20201002)
