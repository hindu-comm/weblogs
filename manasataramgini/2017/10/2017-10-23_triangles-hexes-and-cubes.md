...
![T_n=\\dfrac{n(n+1)}{2} \\rightarrow 1, 3, 6, 10, 15, 21, 28, 36, 45,
...
![tetrahedral_numbers](https://manasataramgini.files.wordpress.com/2017/10/tetrahedral_numbers.png?w=640)Figure
5
...
are nth sums of triangular numbers. Āryabhaṭa-I gives the formula for
the nth sum of triangular numbers by the sūtra:  
...
6](https://s0.wp.com/latex.php?latex=%5Crightarrow+%5Cdiv+6&bg=ffffff&fg=333333&s=0&c=20201002);
sa+eka+pada+ghanaḥ ![\\rightarrow
...
[![triangular_number_sum](https://manasataramgini.files.wordpress.com/2017/10/triangular_number_sum.png?w=700&h=342)](https://manasataramgini.files.wordpress.com/2017/10/triangular_number_sum.png)Figure
...
j](https://s0.wp.com/latex.php?latex=%5Crightarrow+%5Csum_%7Bj%3D1%7D%5En+j&bg=ffffff&fg=333333&s=0&c=20201002);
vargaḥ: squared; yields sum of cubes of natural numbers
(ghanacitighanaḥ). We can use triangular numbers to easily derive this
formula (Figure 7)

![cube_cutting](https://manasataramgini.files.wordpress.com/2017/10/cube_cutting.png?w=640)Figure
...
We then dissect the slab such that we separate the pieces shown in
different colors first. Then we dissect each color piece further along
the grey slicers. These divide the pieces into either square slabs or
half-square slabs of unit cubes. We then assemble these slabs into cubes
of the same color. This demonstrates that,  
...
![S\[n\]=34\\cdot
S\[n-1\]-S\[n-2\]+2](https://s0.wp.com/latex.php?latex=S%5Bn%5D%3D34%5Ccdot+S%5Bn-1%5D-S%5Bn-2%5D%2B2&bg=ffffff&fg=333333&s=0&c=20201002);
where ![S\[0\]=0,
S\[1\]=1](https://s0.wp.com/latex.php?latex=S%5B0%5D%3D0%2C+S%5B1%5D%3D1&bg=ffffff&fg=333333&s=0&c=20201002)
...
is the only prime triangular number, the general formula for hex numbers
is a fairly rich prime-generating  
quadratic. For instance there are 58 ![H_n\|
n\<10000](https://s0.wp.com/latex.php?latex=H_n%7C+n%3C10000&bg=ffffff&fg=333333&s=0&c=20201002)
of which 28 are prime:
![pf=0.4827586](https://s0.wp.com/latex.php?latex=pf%3D0.4827586&bg=ffffff&fg=333333&s=0&c=20201002).
For comparison we draw 58 numbers 10000 taking into account the
following: 1) hex numbers are always odd; 2) they are not evenly
distributed: the first 100 has 6 hex number while the next 100 has only
2. Thus, we make the clustering pattern of our draws identical to that
of hex numbers in windows of 100. Doing a simulation with these
constraints we get a probability of the prime fraction in draws of 58
numbers being
![pf=0.4827586](https://s0.wp.com/latex.php?latex=pf%3D0.4827586&bg=ffffff&fg=333333&s=0&c=20201002)
or higher to be of the order of ![\\approx
0.0002](https://s0.wp.com/latex.php?latex=%5Capprox+0.0002&bg=ffffff&fg=333333&s=0&c=20201002)
(Figure 10).

[![hex_primes](https://manasataramgini.files.wordpress.com/2017/10/hex_primes.png?w=640)](https://manasataramgini.files.wordpress.com/2017/10/hex_primes.png)Figure
10
