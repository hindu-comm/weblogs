...
they shared with the Algol and
![\\beta](https://s0.wp.com/latex.php?latex=%5Cbeta&bg=ffffff&fg=333333&s=0&c=20201002)
...
2\) RV Tauri variables: These tend to be more luminous giant versions of
...
In the remainder of this note we shall explore the period-luminosity law
for classical Cepheids using the wealth of modern data from ground- and
satellite-based observations. To start we take a data-set of 674
Cepheids from the Milky Way for which we have reliable period, mean
visual (V band,
![m_V](https://s0.wp.com/latex.php?latex=m_V&bg=ffffff&fg=333333&s=0&c=20201002))
magnitude and parallax-derived distance information. Using the distance
in parsecs
...
We then plot
![M_V](https://s0.wp.com/latex.php?latex=M_V&bg=ffffff&fg=333333&s=0&c=20201002)
against the base 10 logarithm of the period (in days) of the star to see
if we can recapitulate the period-luminosity law (Figure 1). In Figure 1
the regular classic Cepheids are in blue. The DCEPS group is further
shown in red. Those DCEP that do have an overtone pulsation are colored
violet and those DCEPS with overtone pulsation are colored green.

[![Cepheids_Figure1](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure1.png?w=640)](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure1.png)Figure
1

What we see in Figure 1 is that there is a general positive
period-luminosity correlation. But by no means it can be termed a strong
law  
with a low correlation,
![r^2=.22](https://s0.wp.com/latex.php?latex=r%5E2%3D.22&bg=ffffff&fg=333333&s=0&c=20201002).
Nevertheless we can observe a few interesting things: the DCEPS are not
found at the high end of the luminosity range but they are dominant at
the lower end of the luminosity range. Similarly, the overtone pulsators
are more at the lower side of the range. In any case with a correlation
like this one can hardly expect to use Cepheids as an accurate measure
of distance. So what is the issue here? The answer to this lies in the
observation that was first made in the late 1800s that light from a star
does not reach us unimpeded: it is scattered by dust in interstellar
space. This dust selectively scatters the lower wavelength light towards
the blue end of the spectrum more than that from red end. Details of
this extinction of starlight were worked out only in the last century.
It can be quantified by using the measure
![E\_{B-V}](https://s0.wp.com/latex.php?latex=E_%7BB-V%7D&bg=ffffff&fg=333333&s=0&c=20201002)
which is the observed excess of the difference between the B band and
the V band filter magnitudes relative to the real
![B-V](https://s0.wp.com/latex.php?latex=B-V&bg=ffffff&fg=333333&s=0&c=20201002)
color index.

We have these
![E\_{B-V}](https://s0.wp.com/latex.php?latex=E_%7BB-V%7D&bg=ffffff&fg=333333&s=0&c=20201002)
values for a high-quality data-set which is a subset of 383 brighter
stars of our starting data-set. For this we additionally have the
magnitudes measured in several photometric bands in addition to the V
band. Hence, to start we make the same plot as above of
![M_V](https://s0.wp.com/latex.php?latex=M_V&bg=ffffff&fg=333333&s=0&c=20201002)
computed from distance in parsecs (Figure 2).

[![Cepheids_Figure2](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure2.png?w=640)](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure2.png)Figure
2

We note that even though we have only half the data as in the first plot
and we have lost some of the lower luminosity stars the results are
similar. This suggests that the what we observed above is generally
consistent across the data: a low correlation
![r^2=.23](https://s0.wp.com/latex.php?latex=r%5E2%3D.23&bg=ffffff&fg=333333&s=0&c=20201002).

Now we make use of the
![E\_{B-V}](https://s0.wp.com/latex.php?latex=E_%7BB-V%7D&bg=ffffff&fg=333333&s=0&c=20201002)
values for these stars applying a multiplication factor of 3.23 and
...
[![Cepheids_Figure3](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure3.png?w=640)](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure3.png)Figure
3

Now with a correlation of
![r^2=.92](https://s0.wp.com/latex.php?latex=r%5E2%3D.92&bg=ffffff&fg=333333&s=0&c=20201002)
we get an unambiguous period-luminosity law for the classical Cepheids
ranging from -1.75:-6.4
![M_v](https://s0.wp.com/latex.php?latex=M_v&bg=ffffff&fg=333333&s=0&c=20201002).
The tendency of the low-amplitude DCEPS to be excluded from the high end
of the magnitude-period range is also clear.

In the above approach we solved the issue of extinction of starlight by
interstellar dust on a star-by-star basis using
![E\_{B-V}](https://s0.wp.com/latex.php?latex=E_%7BB-V%7D&bg=ffffff&fg=333333&s=0&c=20201002)
for each star. To tackle this directly rather than for each case the
astronomer Madore defined a new magnitude function called Wesenheit
![W](https://s0.wp.com/latex.php?latex=W&bg=ffffff&fg=333333&s=0&c=20201002)
that is free of the extinction effect. Wesenheit can be calculated by
measuring the magnitude in multiple photometric bands e.g. V and and the
near-infrared I band (806 nm midpoint). For illustration with our
current data-set we shall use the V and I band Wesenheit. For that we
first calculate the near-infrared absolute magnitude from the apparent
...
[![Cepheids_Figure4](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure4.png?w=640)](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure4.png)Figure
4

We see that we now get an even better period-Wesenheit law than with the
case-by-case extinction correction:
![r^2=.98](https://s0.wp.com/latex.php?latex=r%5E2%3D.98&bg=ffffff&fg=333333&s=0&c=20201002).
Thus Wesenheit is a very effective means of capturing the Cepheid
period-luminosity relationship in an extinction independent manner.

[![Cepheids_Figure5](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure5.png?w=640)](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure5.png)Figure
5

Finally, if we look at a histogram of extinction-corrected absolute
magnitudes for these Milky Way Cepheids (Figure 5) we find an
interesting distribution with a clear right skew and hint of bimodality
or a thick right tail. The skew is likely in part an artefact of losing
the lower luminosity overtone pulsators. There is a clear peak at
...
that leads to a fat tail. This suggests that at least in this dataset
classical Cepheids themselves might have at two sub-categories based on
luminosity.

We next turn to classical Cepheids in the Large Magellanic cloud and the
Tarantula nebula. For this we use the data collected by the ground-based
Visible and Infrared Survey Telescope for Astronomy with a 4.1 meter
mirror operating from Chile and released in 2012. This data-set contains
334 Cepheid stars from the LMC and the Tarantula Nebula with high
quality period and magnitude data in the V, I and the
...
regarding whether the star is pulsating in the fundamental mode or has
overtone pulsation. However, there is no direct distance data: the LMC
being extra-galactic is out range for direct parallax measurement.
Hence, we shall use this data to perform a modern recapitulation of the
efforts starting with Hertzsprung. However, in this case like Leavitt
did we can assume that all the stars are at a generally similar distance
from our solar system as they are from a single external galaxy. Thus,
to investigate the period-luminosity law we may directly plot apparent
magnitude
![m_V](https://s0.wp.com/latex.php?latex=m_V&bg=ffffff&fg=333333&s=0&c=20201002)
against
...
[![Cepheids_Figure6](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure6.png?w=640)](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure6.png)Figure
6
...
This formula was based on relatively small sample of Cepheids studied
using the Hubble space telescope.

![M_V=
-2.76(\\log\_{10}(P)-1)-4.16](https://s0.wp.com/latex.php?latex=M_V%3D+-2.76%28%5Clog_%7B10%7D%28P%29-1%29-4.16&bg=ffffff&fg=333333&s=0&c=20201002)  
This formula using the visual band magnitude was derived by Madore and
Freedman in their seminal article on classical Cepheids.

![M_I=
-3.06(\\log\_{10}(P)-1)-4.87](https://s0.wp.com/latex.php?latex=M_I%3D+-3.06%28%5Clog_%7B10%7D%28P%29-1%29-4.87&bg=ffffff&fg=333333&s=0&c=20201002)  
This formula was provided for the infrared I band by Madore and Freedman
in the same article.
...
This formula was based on calibration of Milky Way Cepheids using the
Hipparchos space observatory’s parallax measurements.
...
![M_V](https://s0.wp.com/latex.php?latex=M_V&bg=ffffff&fg=333333&s=0&c=20201002)
computation by these formulae will have the issues of extinction we
shall instead resort other formulae that can correct for this using both
![m_V](https://s0.wp.com/latex.php?latex=m_V&bg=ffffff&fg=333333&s=0&c=20201002)
and
![m_I](https://s0.wp.com/latex.php?latex=m_I&bg=ffffff&fg=333333&s=0&c=20201002)
...
This is the formula of the team of the astronomer Sandage. It seems to
underestimate
...
This is the formula of the Freedman team which is what we shall use for
our purpose. Having calculated
![\\mu](https://s0.wp.com/latex.php?latex=%5Cmu&bg=ffffff&fg=333333&s=0&c=20201002)
we get distances for the stars from it and plot the distribution (Figure
9).

[![Cepheids_Figure9](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure9.png?w=640)](https://manasataramgini.files.wordpress.com/2017/09/cepheids_figure9.png)Figure
9
