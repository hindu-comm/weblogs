...
date = "2017-01-17"
upstream_url = "https://manasataramgini.wordpress.com/2017/01/17/deliberations-on-richness-and-beauty-discovery-of-some-multi-parameter-iterative-maps/"

+++
Source: [here](https://manasataramgini.wordpress.com/2017/01/17/deliberations-on-richness-and-beauty-discovery-of-some-multi-parameter-iterative-maps/).
...
[2](https://manasataramgini.wordpress.com/2016/12/26/some-reminiscences-of-our-study-of-chaotic-maps-2/), [3](https://manasataramgini.wordpress.com/2016/12/25/some-elementary-lessons-from-iterative-fractal-maps/)), the second major factor in our exploration of 2D strange attractors maps, IFS and other fractals was the aesthetic experience they produced. Around that time we came across a curious statement of Plato in the Timaeus: “Now, the one which we maintain to be the most beautiful of all the many figures of triangles (and we need not speak of the others) is that of which the double forms a third, the equilateral triangle.”(translation by Jowett via Birkhoff). Thus, for Plato the most beautiful of triangles is the so-called
![\\frac{\\pi}{6}-\\frac{\\pi}{3}-\\frac{\\pi}{2}](https://s0.wp.com/latex.php?latex=%5Cfrac%7B%5Cpi%7D%7B6%7D-%5Cfrac%7B%5Cpi%7D%7B3%7D-%5Cfrac%7B%5Cpi%7D%7B2%7D&bg=ffffff&fg=333333&s=0&c=20201002)
(a.k.a.
![30-60-90](https://s0.wp.com/latex.php?latex=30-60-90&bg=ffffff&fg=333333&s=0&c=20201002))
triangle. As we meditated upon this statement we realized that this triangle can be recursively used to make many aesthetic polygons beyond the equilateral triangle, like a rectangle, parallelogram, kite (all ![2 \\times](https://s0.wp.com/latex.php?latex=2+%5Ctimes&bg=ffffff&fg=333333&s=0&c=20201002)), square, rhombus (both ![4 \\times](https://s0.wp.com/latex.php?latex=4+%5Ctimes&bg=ffffff&fg=333333&s=0&c=20201002)), hexagon ( ![6 \\times](https://s0.wp.com/latex.php?latex=6+%5Ctimes&bg=ffffff&fg=333333&s=0&c=20201002)). In doing so we realized what Birkhoff had noticed in the 1930s. To us it also illustrated the second of the two basic principles behind aesthetic experience that had dawned on us namely, symmetry and recursion.
...
An attempt to understand the role of complexity in aesthetic experience was made by in the 1930s by Birkhoff. For an aesthetic object he defined two values, “order”
![(O)](https://s0.wp.com/latex.php?latex=%28O%29&bg=ffffff&fg=333333&s=0&c=20201002)
and “complexity”
![(C)](https://s0.wp.com/latex.php?latex=%28C%29&bg=ffffff&fg=333333&s=0&c=20201002),
which led to the aesthetic measure,
![M=\\frac{O}{C}](https://s0.wp.com/latex.php?latex=M%3D%5Cfrac%7BO%7D%7BC%7D&bg=ffffff&fg=333333&s=0&c=20201002).
However, his
![M](https://s0.wp.com/latex.php?latex=M&bg=ffffff&fg=333333&s=0&c=20201002)
measures for various polygons did not have a strong correlation with aesthetic experience they produced in us. This made us suspicious of the value of Birkhoff’s measure. The pioneer in the study of fractals, Mandelbrot, suggested that fractality of an object might be related to the aesthetic experience it produces. Exploration of fractal maps for aesthetics emerged from pioneering productions of physicists/mathematicians like Mira, Gumowski, Sprott, Pickover and Abraham among others. Sprott and Abraham carried out analyses of the aesthetic experience from fractal objects attempting to relate it to their fractal dimension. Based on their experiments they suggested that a fractal dimension in the middle of the range
![1..2](https://s0.wp.com/latex.php?latex=1..2&bg=ffffff&fg=333333&s=0&c=20201002)
was probably a sweet spot for the best aesthetic experience in 2D maps. This generally corresponds to our own aesthetic evaluation of fractal objects.
...
![x\_{n+1} = y_n - sign(x_n)
\\sqrt{\|b\*x_n-c\|}](https://s0.wp.com/latex.php?latex=x_%7Bn%2B1%7D+%3D+y_n+-+sign%28x_n%29+%5Csqrt%7B%7Cb%2Ax_n-c%7C%7D&bg=ffffff&fg=333333&s=0&c=20201002)  
![y\_{n+1} = a -
x_n](https://s0.wp.com/latex.php?latex=y_%7Bn%2B1%7D+%3D+a+-+x_n&bg=ffffff&fg=333333&s=0&c=20201002)
...
are three constants. An examples are shown in Figure 1 and the map is robust over a wide parameter range

![figure1_small](https://manasataramgini.files.wordpress.com/2017/01/figure1_small.png?w=640)Figure 1
...
![x\_{n+1} = y_n - sign(x_n) \\cos \\left( \\dfrac{\\sqrt{\|b x_n - c\|}
d}{2 \\pi} \\right) \\arctan \\left ( \\left (log_l \\left (\|c x_n - b\| \\right ) \\right)^2 \\right)](https://s0.wp.com/latex.php?latex=x_%7Bn%2B1%7D+%3D+y_n+-+sign%28x_n%29+%5Ccos+%5Cleft%28+%5Cdfrac%7B%5Csqrt%7B%7Cb+x_n+-+c%7C%7D+d%7D%7B2+%5Cpi%7D+%5Cright%29+%5Carctan+%5Cleft+%28+%5Cleft+%28log_l+%5Cleft+%28%7Cc+x_n+-+b%7C+%5Cright+%29+%5Cright%29%5E2+%5Cright%29&bg=ffffff&fg=333333&s=0&c=20201002)  
![y\_{n+1} = a -
x_n](https://s0.wp.com/latex.php?latex=y_%7Bn%2B1%7D+%3D+a+-+x_n&bg=ffffff&fg=333333&s=0&c=20201002)  
In place of
![\\cos()](https://s0.wp.com/latex.php?latex=%5Ccos%28%29&bg=ffffff&fg=333333&s=0&c=20201002)
in the first x-mapping we could also have
![\\sin()](https://s0.wp.com/latex.php?latex=%5Csin%28%29&bg=ffffff&fg=333333&s=0&c=20201002).  
Then we subject
![(x\_{n+1},y\_{n+1})](https://s0.wp.com/latex.php?latex=%28x_%7Bn%2B1%7D%2Cy_%7Bn%2B1%7D%29&bg=ffffff&fg=333333&s=0&c=20201002)
to a further “affine” rotation before plotting it:  
![x\_{n+1}=x\_{n+1} \\cos(k) - y\_{n+1}
\\sin(k)](https://s0.wp.com/latex.php?latex=x_%7Bn%2B1%7D%3Dx_%7Bn%2B1%7D+%5Ccos%28k%29+-+y_%7Bn%2B1%7D+%5Csin%28k%29&bg=ffffff&fg=333333&s=0&c=20201002)  
![y\_{n+1}=x\_{n+1} \\sin(k) + y\_{n+1}
\\cos(k)](https://s0.wp.com/latex.php?latex=y_%7Bn%2B1%7D%3Dx_%7Bn%2B1%7D+%5Csin%28k%29+%2B+y_%7Bn%2B1%7D+%5Ccos%28k%29&bg=ffffff&fg=333333&s=0&c=20201002)
...
Map-2 works thus:  
![x\_{n+1}=y_n-sign(x_n) \\cos \\left ( \\dfrac {log\_{l1}(\|b x_n-c\|)
d} {2 \\pi} \\right) \\arctan \\left(\\left(log\_{l2}\\left(\|c x_n-b\|\\right)\\right)^2\\right)](https://s0.wp.com/latex.php?latex=x_%7Bn%2B1%7D%3Dy_n-sign%28x_n%29+%5Ccos+%5Cleft+%28+%5Cdfrac+%7Blog_%7Bl1%7D%28%7Cb+x_n-c%7C%29+d%7D+%7B2+%5Cpi%7D+%5Cright%29+%5Carctan+%5Cleft%28%5Cleft%28log_%7Bl2%7D%5Cleft%28%7Cc+x_n-b%7C%5Cright%29%5Cright%29%5E2%5Cright%29&bg=ffffff&fg=333333&s=0&c=20201002)  
![y\_{n+1}=a-x_n](https://s0.wp.com/latex.php?latex=y_%7Bn%2B1%7D%3Da-x_n&bg=ffffff&fg=333333&s=0&c=20201002)  
In place of
![\\cos()](https://s0.wp.com/latex.php?latex=%5Ccos%28%29&bg=ffffff&fg=333333&s=0&c=20201002)
in the first x-mapping we could also have
![\\sin()](https://s0.wp.com/latex.php?latex=%5Csin%28%29&bg=ffffff&fg=333333&s=0&c=20201002).  
...
The constants here are similar to those in the above map but we have one extra one because we have two distinct logarithm terms. Finally in both these maps replacing
...
also produces interesting maps. Figures 2 and 3 respectively show examples of each of the above maps.

![figure2_small](https://manasataramgini.files.wordpress.com/2017/01/figure2_small.png?w=640)Figure 2 (First two with
![\\cos()](https://s0.wp.com/latex.php?latex=%5Ccos%28%29&bg=ffffff&fg=333333&s=0&c=20201002)
and second two with
![\\sin()](https://s0.wp.com/latex.php?latex=%5Csin%28%29&bg=ffffff&fg=333333&s=0&c=20201002)

![figure3_small](https://manasataramgini.files.wordpress.com/2017/01/figure3_small.png?w=640)Figure 3 (all maps use
![\\tanh()](https://s0.wp.com/latex.php?latex=%5Ctanh%28%29&bg=ffffff&fg=333333&s=0&c=20201002)
in place of
![\\arctan()](https://s0.wp.com/latex.php?latex=%5Carctan%28%29&bg=ffffff&fg=333333&s=0&c=20201002)
