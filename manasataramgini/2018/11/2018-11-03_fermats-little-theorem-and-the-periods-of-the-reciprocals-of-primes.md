...
words. Now, these remaining words, by the above principle of arranging
on directed ring graphs, can be grouped into
![k](https://s0.wp.com/latex.php?latex=k&bg=ffffff&fg=333333&s=0&c=20201002)
sets each of
![p](https://s0.wp.com/latex.php?latex=p&bg=ffffff&fg=333333&s=0&c=20201002)
words. Thus, ![a^p-a=
kp](https://s0.wp.com/latex.php?latex=a%5Ep-a%3D+kp&bg=ffffff&fg=333333&s=0&c=20201002);
therefore it will be divisible by
![p](https://s0.wp.com/latex.php?latex=p&bg=ffffff&fg=333333&s=0&c=20201002).
Alternatively,

![(a^p-a) \\mod p =0; \\; \\therefore (a^{p-1}-1) \\mod p=0; \\;
\\therefore a^{p-1} \\mod p
=1](https://s0.wp.com/latex.php?latex=%28a%5Ep-a%29+%5Cmod+p+%3D0%3B+%5C%3B+%5Ctherefore+%28a%5E%7Bp-1%7D-1%29+%5Cmod+p%3D0%3B+%5C%3B+%5Ctherefore+a%5E%7Bp-1%7D+%5Cmod+p+%3D1&bg=ffffff&fg=333333&s=0&c=20201002)
...
which we had encountered in the [previous
...
![10=2 \\times
5](https://s0.wp.com/latex.php?latex=10%3D2+%5Ctimes+5&bg=ffffff&fg=333333&s=0&c=20201002);
i.e., the decimal system. While some islanders of Papua have apparently
opted for the smaller senary system based on
...
We asked our father why this was so? He told us to focus on: 1)
reciprocals, i.e. fractions of the type
![\\tfrac{1}{a}](https://s0.wp.com/latex.php?latex=%5Ctfrac%7B1%7D%7Ba%7D&bg=ffffff&fg=333333&s=0&c=20201002)
because all other fractions are integer multiples of such and 2) to look
out for primes. Then thinking it would be good for us to get some
practice with division, he let us keep to dividing 1 by various numbers.

If one were to do this arithmetic operation, sooner or later, one
realizes the following:  
1) Only fractions of the form ![\\tfrac{1}{2^m
5^n}](https://s0.wp.com/latex.php?latex=%5Ctfrac%7B1%7D%7B2%5Em+5%5En%7D&bg=ffffff&fg=333333&s=0&c=20201002)
or their multiple terminate. The number of decimal places after which
they terminate is
![\\max(m,n)](https://s0.wp.com/latex.php?latex=%5Cmax%28m%2Cn%29&bg=ffffff&fg=333333&s=0&c=20201002).
This is easily understood. One needs to divide as many units as the
maximum number of times 2 or 5 appear in the denominator; hence, the
decimal fraction terminates after that many digits after the point.

2\) If the fraction is of the form ![\\tfrac{1}{2^m 5^n p_1^a
p_2^b...}](https://s0.wp.com/latex.php?latex=%5Ctfrac%7B1%7D%7B2%5Em+5%5En+p_1%5Ea+p_2%5Eb...%7D&bg=ffffff&fg=333333&s=0&c=20201002),
where ![p_1,
p_2...](https://s0.wp.com/latex.php?latex=p_1%2C+p_2...&bg=ffffff&fg=333333&s=0&c=20201002)
are the primes other than 2 and 5 then it always cycles after an initial
run of numbers whose length again depends of the ![2^m
5^n](https://s0.wp.com/latex.php?latex=2%5Em+5%5En&bg=ffffff&fg=333333&s=0&c=20201002)
part of the denominator as in the first case.
...
where
![p](https://s0.wp.com/latex.php?latex=p&bg=ffffff&fg=333333&s=0&c=20201002)
is any prime other than 2 or 5. Such fractions are always pure cycles in
...
l=1](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B1%7D%7B3%7D%3D0.%5Coverline%7B3%7D%3B+l%3D1&bg=ffffff&fg=333333&s=0&c=20201002)

![\\dfrac{1}{7}= 0.\\overline{142857};
l=6](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B1%7D%7B7%7D%3D+0.%5Coverline%7B142857%7D%3B+l%3D6&bg=ffffff&fg=333333&s=0&c=20201002)

![\\dfrac{1}{11}=0.\\overline{09};
l=2](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B1%7D%7B11%7D%3D0.%5Coverline%7B09%7D%3B+l%3D2&bg=ffffff&fg=333333&s=0&c=20201002)

![\\dfrac{1}{13}=0.\\overline{076923};
l=6](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B1%7D%7B13%7D%3D0.%5Coverline%7B076923%7D%3B+l%3D6&bg=ffffff&fg=333333&s=0&c=20201002)

![\\dfrac{1}{17}=0.\\overline{ 0588235294117647};
l=16](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B1%7D%7B17%7D%3D0.%5Coverline%7B+0588235294117647%7D%3B+l%3D16&bg=ffffff&fg=333333&s=0&c=20201002)

![\\dfrac{1}{19}=0.\\overline{ 052631578947368421};
l=18](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B1%7D%7B19%7D%3D0.%5Coverline%7B+052631578947368421%7D%3B+l%3D18&bg=ffffff&fg=333333&s=0&c=20201002)
...
![3\\times 3=
9](https://s0.wp.com/latex.php?latex=3%5Ctimes+3%3D+9&bg=ffffff&fg=333333&s=0&c=20201002).
Hence, the cycle for
...
Similarly, ![7\\times 142857=
999999](https://s0.wp.com/latex.php?latex=7%5Ctimes+142857%3D+999999&bg=ffffff&fg=333333&s=0&c=20201002).
Hence, the cycle for
...
Another example: ![11\\times 09=
99](https://s0.wp.com/latex.php?latex=11%5Ctimes+09%3D+99&bg=ffffff&fg=333333&s=0&c=20201002).
Hence, the cycle for
...
This can be formally expressed thus: When ![10^n \\mod p =
1](https://s0.wp.com/latex.php?latex=10%5En+%5Cmod+p+%3D+1&bg=ffffff&fg=333333&s=0&c=20201002)
then the length of the decimal cycle of
![\\tfrac{1}{p}](https://s0.wp.com/latex.php?latex=%5Ctfrac%7B1%7D%7Bp%7D&bg=ffffff&fg=333333&s=0&c=20201002)
is
...
By Fermat’s little theorem (see above), ![10^{p-1} \\mod p
=1](https://s0.wp.com/latex.php?latex=10%5E%7Bp-1%7D+%5Cmod+p+%3D1&bg=ffffff&fg=333333&s=0&c=20201002).
Thus, we will reach a number 1 less than a power of 10, which is also
divisible by
![p](https://s0.wp.com/latex.php?latex=p&bg=ffffff&fg=333333&s=0&c=20201002),
latest by
...
In the above examples we see this for 7, 17 and 19. An examination of
the distribution of the digits from
![0..9](https://s0.wp.com/latex.php?latex=0..9&bg=ffffff&fg=333333&s=0&c=20201002)
for fractions with long cycles shows that they are all present in equal
frequency.
...
The Englishman W. Shanks was the first to compute this sequence in the
pre-computer era for every
![p\<20000](https://s0.wp.com/latex.php?latex=p%3C20000&bg=ffffff&fg=333333&s=0&c=20201002),
i.e., the first 2262 primes and triumphantly presented his results
before the Royal Society of England. Unlike Shanks, in our first attempt
at this in our childhood we quickly ran out of steam but we had at least
obtained some basic picture of the “lay of the land” of the sequence
![f](https://s0.wp.com/latex.php?latex=f&bg=ffffff&fg=333333&s=0&c=20201002).
...
857](https://s0.wp.com/latex.php?latex=f%5B4%5D%3D6+%5Cequiv+%5Cdfrac%7B1%7D%7B7%7D+%5Cequiv+0.142+%7C+857&bg=ffffff&fg=333333&s=0&c=20201002)

![f\[7\]=16 \\equiv \\dfrac{1}{17} \\equiv 0.05882352 \|
94117647](https://s0.wp.com/latex.php?latex=f%5B7%5D%3D16+%5Cequiv+%5Cdfrac%7B1%7D%7B17%7D+%5Cequiv+0.05882352+%7C+94117647&bg=ffffff&fg=333333&s=0&c=20201002)
...
![\\tfrac{l}{2}](https://s0.wp.com/latex.php?latex=%5Ctfrac%7Bl%7D%7B2%7D&bg=ffffff&fg=333333&s=0&c=20201002)
digits is 9; e.g. in the case of ![p_n=7:
1+8=4+5=2+7=9](https://s0.wp.com/latex.php?latex=p_n%3D7%3A+1%2B8%3D4%2B5%3D2%2B7%3D9&bg=ffffff&fg=333333&s=0&c=20201002).
Likewise, for ![p_n=17:
0+9=5+4=8+1=8+1=2+7=3+6=5+5=2+7=9](https://s0.wp.com/latex.php?latex=p_n%3D17%3A+0%2B9%3D5%2B4%3D8%2B1%3D8%2B1%3D2%2B7%3D3%2B6%3D5%2B5%3D2%2B7%3D9&bg=ffffff&fg=333333&s=0&c=20201002).
This knowledge halves the calculation as long as you know you have
reached the midpoint of the cycle. But this leads to the question: what
is the distribution of cycle lengths? A good way to approach this
question is by plotting
![f\[n\]](https://s0.wp.com/latex.php?latex=f%5Bn%5D&bg=ffffff&fg=333333&s=0&c=20201002)
...
where ![k=1, 2, 3,
4...](https://s0.wp.com/latex.php?latex=k%3D1%2C+2%2C+3%2C+4...&bg=ffffff&fg=333333&s=0&c=20201002).
Those where the cycle length is of the form
...
![k](https://s0.wp.com/latex.php?latex=k&bg=ffffff&fg=333333&s=0&c=20201002)
is even we can get odd-length cycles, the number of primes with
odd-length cycles will be less than the number of primes with
even-length cycles. The ratio of the number of odd-length cycles to
even-length cycles for the first 2262 primes it is 0.487. While it close
to
![\\tfrac{1}{2}](https://s0.wp.com/latex.php?latex=%5Ctfrac%7B1%7D%7B2%7D&bg=ffffff&fg=333333&s=0&c=20201002),
...
![p_n](https://s0.wp.com/latex.php?latex=p_n&bg=ffffff&fg=333333&s=0&c=20201002)
can be classified into different families depending on which line of the
form
![y=\\tfrac{x-1}{k}](https://s0.wp.com/latex.php?latex=y%3D%5Ctfrac%7Bx-1%7D%7Bk%7D&bg=ffffff&fg=333333&s=0&c=20201002)
