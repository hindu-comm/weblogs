...
opened a new type of understanding forold problems.

![equilateral_triangle2](https://manasataramgini.files.wordpress.com/2016/11/equilateral_triangle2.jpg?w=640)*Figure
...
defines the equilateral ![\\triangle
ABB'](https://s0.wp.com/latex.php?latex=%5Ctriangle+ABB%27&bg=ffffff&fg=333333&s=0&c=20201002).  
4) Once you have an equilateral triangle we can determine its center and
use that to fold a hexagon (all described by Rao).
...
![\\overline{MN}](https://s0.wp.com/latex.php?latex=%5Coverline%7BMN%7D&bg=ffffff&fg=333333&s=0&c=20201002).
Do the same with point O so that point I lies on the vertical bisector
of the square. This operation will establish point P. Folding along
...
and diagonals of unit length, where the unit is the side of the starting
square paper.
...
which was first achieved by Margherita Beloch 1936 CE. We first
illustrate how this can be done and the proof of it using elementary
geometry.

![origami_doubling_cube](https://manasataramgini.files.wordpress.com/2016/11/origami_doubling_cube.png?w=640)*Figure
7: Doubling the cube*
...
which is the diagonal of the rectangle AEFB that was formed by the
previous crease.  
...
Their intersection would hence be ![\\left (\\dfrac{2}{3},\\dfrac{1}{3}
\\right)](https://s0.wp.com/latex.php?latex=%5Cleft+%28%5Cdfrac%7B2%7D%7B3%7D%2C%5Cdfrac%7B1%7D%7B3%7D+%5Cright%29&bg=ffffff&fg=333333&s=0&c=20201002).
This is the rationale for the trisection of the square.
...
![1:\\sqrt\[3\]{2}](https://s0.wp.com/latex.php?latex=1%3A%5Csqrt%5B3%5D%7B2%7D&bg=ffffff&fg=333333&s=0&c=20201002)
we can then fold two squares with sides equal to each partition. Each
square is then separated and folded into a cube using the Japanese
waterbomb method. This will result in cubes whose volumes are in the
ratio
![1:2](https://s0.wp.com/latex.php?latex=1%3A2&bg=ffffff&fg=333333&s=0&c=20201002).

![doubling_cube](https://manasataramgini.files.wordpress.com/2016/11/doubling_cube.jpg?w=640)*Figure
8: Cubes doubled*
...
In ![\\triangle
AJB2](https://s0.wp.com/latex.php?latex=%5Ctriangle+AJB2&bg=ffffff&fg=333333&s=0&c=20201002)
let
...
Thus, by the bhujā-koṭi-karṇa-nyāya we have: ![1+y^2=(x+1-y)^2 \\;
\\therefore
y=\\dfrac{x^2+2x}{2x+2}](https://s0.wp.com/latex.php?latex=1%2By%5E2%3D%28x%2B1-y%29%5E2+%5C%3B+%5Ctherefore+y%3D%5Cdfrac%7Bx%5E2%2B2x%7D%7B2x%2B2%7D&bg=ffffff&fg=333333&s=0&c=20201002).

We can see that ![\\triangle AJB_2 \\sim \\triangle
A'I'B_2](https://s0.wp.com/latex.php?latex=%5Ctriangle+AJB_2+%5Csim+%5Ctriangle+A%27I%27B_2&bg=ffffff&fg=333333&s=0&c=20201002).  
Thus, ![\\overline{AJ} \\equiv
\\overline{A'B_2}](https://s0.wp.com/latex.php?latex=%5Coverline%7BAJ%7D+%5Cequiv+%5Coverline%7BA%27B_2%7D&bg=ffffff&fg=333333&s=0&c=20201002)
and ![\\overline{I'B_2} \\equiv
\\overline{JB_2}](https://s0.wp.com/latex.php?latex=%5Coverline%7BI%27B_2%7D+%5Cequiv+%5Coverline%7BJB_2%7D&bg=ffffff&fg=333333&s=0&c=20201002).
...
![origami_angle_trisection](https://manasataramgini.files.wordpress.com/2016/11/origami_angle_trisection.png?w=640)*Figure
