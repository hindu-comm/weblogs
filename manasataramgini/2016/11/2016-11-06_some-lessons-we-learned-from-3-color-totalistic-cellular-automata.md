...
we can represent the rule by merely providing the vector of cell state
...
which shows a sterile pattern in a single cell initiation that goes
extinct after 4 generations. However, when it is initiated with a random
array of the three values it develops a complex pattern with several
branches as well as runs of linear repetitive patterns. Thus, a singly
sterile rule when given the opportunity to interact with other
initiations as a result of the random initiation develops into a complex
system. We term this symbiotic development.

2\) Rule
![0022010](https://s0.wp.com/latex.php?latex=0022010&bg=ffffff&fg=333333&s=0&c=20201002)
shows some initial complex patterns but all of these are quickly
channelized into simple linear repetitive patterns. Likewise, rules
...
initially evolve complex branching which then goes extinct and leaving
just one or two dominant complex linear repetitive strands. In rule
![1012020](https://s0.wp.com/latex.php?latex=1012020&bg=ffffff&fg=333333&s=0&c=20201002)
the initial complexity is quickly channelized into both simple and
complex linear repetitive patterns.

3\) Rule
![1022010](https://s0.wp.com/latex.php?latex=1022010&bg=ffffff&fg=333333&s=0&c=20201002)
produces expanding repetitive patterns which are interspersed with runs
of simple linear patterns.
...
quickly produce chaotic structures but these have certain stereotypic
sub-structures.
...
rapidly converge to even more chaotic structures than the above,
spawning what look closer to completely random patterns.
