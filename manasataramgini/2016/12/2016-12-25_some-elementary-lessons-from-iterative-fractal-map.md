...
However, there can be a set of n such of matrices
...
For each mapping of the point we have 7 numbers, 6 from the
transformation matrices
![(a..f)](https://s0.wp.com/latex.php?latex=%28a..f%29&bg=ffffff&fg=333333&s=0&c=20201002)
and the 7th being the probability with which it is applied
![p_i](https://s0.wp.com/latex.php?latex=p_i&bg=ffffff&fg=333333&s=0&c=20201002).
...
![24+4=28](https://s0.wp.com/latex.php?latex=24%2B4%3D28&bg=ffffff&fg=333333&s=0&c=20201002)
‘genes’ which might be mutated. If we impose the conditions of
continuity of the attractor region (a very real biological one) and
...
![ifs_leaf](https://manasataramgini.files.wordpress.com/2016/12/ifs_leaf.png?w=640)Figure
2
