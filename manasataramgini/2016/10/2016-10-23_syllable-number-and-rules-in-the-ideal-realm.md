...
3\) Another personal example: around the 14th year of our life we constructed a curve known as the witch (of Agnesi), which is rather trivial:![witch](https://manasataramgini.files.wordpress.com/2016/10/witch2.png?w=640)

\* Draw the generating circle which is tangent to the x-axis at origin O and radius
...
\* The locus of D as a B moves on the generating circle is the witch which has the equation:
...
![\\displaystyle \\sum\_{n=0}^{16} (2n+1) = (n+1)^2= 289](https://s0.wp.com/latex.php?latex=%5Cdisplaystyle+%5Csum_%7Bn%3D0%7D%5E%7B16%7D+%282n%2B1%29+%3D+%28n%2B1%29%5E2%3D+289&bg=ffffff&fg=333333&s=0&c=20201002)
...
Thus, the first square is one brick. Adding 3 bricks the next in the sequence on its 3 sides give you
...
values we get a generally similar frequency distribution of the values visited by
...
Strikingly, even though the bulk distribution is generally similar for all starting values the actual behavior of
![x_n](https://s0.wp.com/latex.php?latex=x_n&bg=ffffff&fg=333333&s=0&c=20201002)
is very sensitive to the starting value. For example in the figure we illustrate the evolution of 0.5 versus 0.50001 over 300 iterations. One can notice that beyond the 20th iteration the two sequences completely diverge that they have nothing in common despite similar bulk statistics.
...
![x_n=\\left \\lfloor (n+1)h \\right \\rfloor -\\left \\lfloor nh \\right \\rfloor](https://s0.wp.com/latex.php?latex=x_n%3D%5Cleft+%5Clfloor+%28n%2B1%29h+%5Cright+%5Crfloor+-%5Cleft+%5Clfloor+nh+%5Cright+%5Crfloor&bg=ffffff&fg=333333&s=0&c=20201002)  
where
...
The floor-difference sequence which results from the above rule can be represented as shown in the figure – as a step graph – a sequence of up and down values. This set of up and down values can hence be also represented as a binary string. When
![h](https://s0.wp.com/latex.php?latex=h&bg=ffffff&fg=333333&s=0&c=20201002)
is a rational fraction like 3/2 then we get a regularly repetitive graph which translates into a regular binary string like
![10101...](https://s0.wp.com/latex.php?latex=10101...&bg=ffffff&fg=333333&s=0&c=20201002).
Now if
![h](https://s0.wp.com/latex.php?latex=h&bg=ffffff&fg=333333&s=0&c=20201002)
is instead an irrational number then we do not get a repetitive graph. Instead, there are more complex patterns which have their own structure. For example, Stephen Wolfram, the pioneer in the study of such systems, has shown that if
![h](https://s0.wp.com/latex.php?latex=h&bg=ffffff&fg=333333&s=0&c=20201002)
is a root of a quadratic equation then the pattern of the sequence is obtained by an automaton with simple substitution rules. Thus, he has shown the following substitution rules:

![\\sqrt{2}:\\; 0 \\rightarrow 0,1; \\; 1 \\rightarrow 0,1,0\\\\ \\sqrt{3}:\\; 0 \\rightarrow 1,1,0; \\; 1 \\rightarrow 1,1,0,1\\\\ \\phi: 0 \\rightarrow 1; \\; 1 \\rightarrow 1,0](https://s0.wp.com/latex.php?latex=%5Csqrt%7B2%7D%3A%5C%3B+0+%5Crightarrow+0%2C1%3B+%5C%3B+1+%5Crightarrow+0%2C1%2C0%5C%5C+%5Csqrt%7B3%7D%3A%5C%3B+0+%5Crightarrow+1%2C1%2C0%3B+%5C%3B+1+%5Crightarrow+1%2C1%2C0%2C1%5C%5C+%5Cphi%3A+0+%5Crightarrow+1%3B+%5C%3B+1+%5Crightarrow+1%2C0&bg=ffffff&fg=333333&s=0&c=20201002)  
These can be easily verified with the figure.

However, for other irrational numbers the rulers are more complex or subtle. The case of ![h= e](https://s0.wp.com/latex.php?latex=h%3D+e&bg=ffffff&fg=333333&s=0&c=20201002) or ![h= \\pi ](https://s0.wp.com/latex.php?latex=h%3D+%5Cpi+&bg=ffffff&fg=333333&s=0&c=20201002) is rather notable. For
![e](https://s0.wp.com/latex.php?latex=e&bg=ffffff&fg=333333&s=0&c=20201002)
we see that the step graph looks quasi-regular: it can represented as repeats of the binary string
![1101110](https://s0.wp.com/latex.php?latex=1101110&bg=ffffff&fg=333333&s=0&c=20201002).
This goes fine till we reach position 32 at which place a we get an unexpected string
![11101110](https://s0.wp.com/latex.php?latex=11101110&bg=ffffff&fg=333333&s=0&c=20201002).
Then it resumes again as usual with the repeat of the earlier string till position 71 where we again get
![11101110](https://s0.wp.com/latex.php?latex=11101110&bg=ffffff&fg=333333&s=0&c=20201002).
From this we see that first deviation occurs at 32 and second at 39 from the point of the first deviation. From then on this pattern repeats with successive insertions of the string
![11101110](https://s0.wp.com/latex.php?latex=11101110&bg=ffffff&fg=333333&s=0&c=20201002)
occurring alternately at 32 and 39 positions from the previous one. Thus, we can predict and see the string
![11101110](https://s0.wp.com/latex.php?latex=11101110&bg=ffffff&fg=333333&s=0&c=20201002)
...
To understand the secret behind this interesting pattern we have to turn to the continued fraction representation of
![e](https://s0.wp.com/latex.php?latex=e&bg=ffffff&fg=333333&s=0&c=20201002),
which was developed by the great Leonhard Euler. By working out the fractions to successive terms we get increasingly better approximations of
![e](https://s0.wp.com/latex.php?latex=e&bg=ffffff&fg=333333&s=0&c=20201002),
which are listed below starting from the 0th :  
![(0) \\; 2 \\; (1) \\; 3\\; (2) \\;\\dfrac{8}{3}\\; (3)
\\;\\dfrac{11}{4} (4) \\;\\dfrac{19}{7}\\; (5) \\; \\dfrac{87}{32}\\;
(6) \\;\\dfrac{106}{39}\\; (7) \\;\\dfrac{193}{71}\\\\\[10pt\] (8)
\\;\\dfrac{1264}{465}\\; (9) \\;\\dfrac{1457}{536}\\; (10) \\;\\dfrac{2721}{1001}\\; (11)\\; \\;\\dfrac{23225}{8544}](https://s0.wp.com/latex.php?latex=%280%29+%5C%3B+2+%5C%3B+%281%29+%5C%3B+3%5C%3B+%282%29+%5C%3B%5Cdfrac%7B8%7D%7B3%7D%5C%3B+%283%29+%5C%3B%5Cdfrac%7B11%7D%7B4%7D+%284%29+%5C%3B%5Cdfrac%7B19%7D%7B7%7D%5C%3B+%285%29+%5C%3B+%5Cdfrac%7B87%7D%7B32%7D%5C%3B+%286%29+%5C%3B%5Cdfrac%7B106%7D%7B39%7D%5C%3B+%287%29+%5C%3B%5Cdfrac%7B193%7D%7B71%7D%5C%5C%5B10pt%5D+%288%29+%5C%3B%5Cdfrac%7B1264%7D%7B465%7D%5C%3B+%289%29+%5C%3B%5Cdfrac%7B1457%7D%7B536%7D%5C%3B+%2810%29+%5C%3B%5Cdfrac%7B2721%7D%7B1001%7D%5C%3B+%2811%29%5C%3B+%5C%3B%5Cdfrac%7B23225%7D%7B8544%7D&bg=ffffff&fg=333333&s=0&c=20201002)

Now the floor-difference sequence for the first fractional approximation
![\\dfrac{8}{3}](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B8%7D%7B3%7D&bg=ffffff&fg=333333&s=0&c=20201002)
produces a repeat of the string
![110](https://s0.wp.com/latex.php?latex=110&bg=ffffff&fg=333333&s=0&c=20201002);
the next approximation
![\\dfrac{11}{4}](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B11%7D%7B4%7D&bg=ffffff&fg=333333&s=0&c=20201002)
yields the repeats of string
![1110](https://s0.wp.com/latex.php?latex=1110&bg=ffffff&fg=333333&s=0&c=20201002);
the next approximation
![\\dfrac{19}{7}](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B19%7D%7B7%7D&bg=ffffff&fg=333333&s=0&c=20201002)
yields the string
![1101110](https://s0.wp.com/latex.php?latex=1101110&bg=ffffff&fg=333333&s=0&c=20201002).
Thus, the first three approximations set up the basic pattern which forms the floor-difference sequence of
![e](https://s0.wp.com/latex.php?latex=e&bg=ffffff&fg=333333&s=0&c=20201002).
We then note that the appearance of the deviant pattern
![11101110](https://s0.wp.com/latex.php?latex=11101110&bg=ffffff&fg=333333&s=0&c=20201002),
corresponding to positions alternately separated by 32 and 39
(71=32+39), is related to the denominators of the next three
approximations. Strikingly, the further points where we observed break of the preexisting pattern occur at or upon crossing of 536 and 1001 which define the denominators of the 9th and 10th cycles of approximation.

Now when we look at the step graph for the floor-difference sequence of
![\\pi
](https://s0.wp.com/latex.php?latex=%5Cpi+&bg=ffffff&fg=333333&s=0&c=20201002) we see that it shows a strikingly regular pattern which can represented as repeats of the string
![0000001](https://s0.wp.com/latex.php?latex=0000001&bg=ffffff&fg=333333&s=0&c=20201002).
We see 15 such repeats till we reach the position 106 where we see a deviant string
![00000001](https://s0.wp.com/latex.php?latex=00000001&bg=ffffff&fg=333333&s=0&c=20201002).
Then it resumes with the usual repeat until position 219 where we again see the deviant string as above. This deviant string then reappears regularly at 332, 445, 558, 671, 784, 897, 1010, 1123… i.e. every 113th position. Now the secret of this pattern becomes clear when we look at the continued fraction derived approximations of ![\\pi ](https://s0.wp.com/latex.php?latex=%5Cpi+&bg=ffffff&fg=333333&s=0&c=20201002) starting from the 0th cycle:

![(0) \\; 3 \\; (1) \\;\\dfrac{22}{7}\\;(2) \\;\\dfrac{333}{106}\\;(3) \\; \\dfrac{355}{113}\\\\\[10pt\] (4) \\; \\dfrac{103993}{33102}\\; (5) \\; \\dfrac{104348}{33215}](https://s0.wp.com/latex.php?latex=%280%29+%5C%3B+3+%5C%3B+%281%29+%5C%3B%5Cdfrac%7B22%7D%7B7%7D%5C%3B%282%29+%5C%3B%5Cdfrac%7B333%7D%7B106%7D%5C%3B%283%29+%5C%3B+%5Cdfrac%7B355%7D%7B113%7D%5C%5C%5B10pt%5D+%284%29+%5C%3B+%5Cdfrac%7B103993%7D%7B33102%7D%5C%3B+%285%29+%5C%3B+%5Cdfrac%7B104348%7D%7B33215%7D&bg=ffffff&fg=333333&s=0&c=20201002)

The 0th approximation 3 is the ancient one which is already alluded to as \*approximation\* of
![\\pi](https://s0.wp.com/latex.php?latex=%5Cpi&bg=ffffff&fg=333333&s=0&c=20201002)
even the RV. The 1st approximation
![\\dfrac{22}{7}](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B22%7D%7B7%7D&bg=ffffff&fg=333333&s=0&c=20201002)
is what Archimedes arrived at. Its floor-difference step graph corresponds to a sequence starting with the string
![000001](https://s0.wp.com/latex.php?latex=000001&bg=ffffff&fg=333333&s=0&c=20201002)
followed by never-ending repeats of
![0000001](https://s0.wp.com/latex.php?latex=0000001&bg=ffffff&fg=333333&s=0&c=20201002).
This later string sets up the basic pattern of the
![\\pi](https://s0.wp.com/latex.php?latex=%5Cpi&bg=ffffff&fg=333333&s=0&c=20201002)
sequence. Then we see that as with
![e](https://s0.wp.com/latex.php?latex=e&bg=ffffff&fg=333333&s=0&c=20201002)
the denominator of the 2nd approximation yields the point where the first deviant string appears (106). Then the next copy of that deviant string appears 113 positions away from that point, 113 being the denominator of the next approximation. The next irregularity is would appear in the vicinity of the denominator of the next approximation, which is way beyond the number of iterations to which we have calculated the sequence. That explains why
![\\dfrac{355}{113}](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B355%7D%7B113%7D&bg=ffffff&fg=333333&s=0&c=20201002)
serves as great approximation for
![\\pi](https://s0.wp.com/latex.php?latex=%5Cpi&bg=ffffff&fg=333333&s=0&c=20201002)
and was so remarkably captured by Srinivasa Ramanujan in his first construction to approximately square the circle.
...
be a fractional or irrational number like ![\\pi, \\sqrt(2), \\phi ](https://s0.wp.com/latex.php?latex=%5Cpi%2C+%5Csqrt%282%29%2C+%5Cphi+&bg=ffffff&fg=333333&s=0&c=20201002).  
...
![dt\_{n+1}=dt_n+2\\pi \\times s\\\\ t\_{n+1}=t_n+dt\_{n+1}\\\\
x\_{n+1}=x_n+\\cos(t\_{n+1})\\\\ y\_{n+1}=y_n+\\sin(t\_{n+1}) ](https://s0.wp.com/latex.php?latex=dt_%7Bn%2B1%7D%3Ddt_n%2B2%5Cpi+%5Ctimes+s%5C%5C+t_%7Bn%2B1%7D%3Dt_n%2Bdt_%7Bn%2B1%7D%5C%5C+x_%7Bn%2B1%7D%3Dx_n%2B%5Ccos%28t_%7Bn%2B1%7D%29%5C%5C+y_%7Bn%2B1%7D%3Dy_n%2B%5Csin%28t_%7Bn%2B1%7D%29+&bg=ffffff&fg=333333&s=0&c=20201002)  
4) Join successive points
![(x_n,y_n)](https://s0.wp.com/latex.php?latex=%28x_n%2Cy_n%29&bg=ffffff&fg=333333&s=0&c=20201002)
to get the desired curlicue. The figure shows curlicues generated using various seeds run for 2000 iterations. Top row from left: 1)
![\\pi](https://s0.wp.com/latex.php?latex=%5Cpi&bg=ffffff&fg=333333&s=0&c=20201002);
2)
![\\sqrt{10}](https://s0.wp.com/latex.php?latex=%5Csqrt%7B10%7D&bg=ffffff&fg=333333&s=0&c=20201002);
3)
![\\dfrac{355}{113}](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B355%7D%7B113%7D&bg=ffffff&fg=333333&s=0&c=20201002);
4) ![\\phi ](https://s0.wp.com/latex.php?latex=%5Cphi+&bg=ffffff&fg=333333&s=0&c=20201002) Bottom row from left: 5) ![e ](https://s0.wp.com/latex.php?latex=e+&bg=ffffff&fg=333333&s=0&c=20201002); 6)
![\\log(2)](https://s0.wp.com/latex.php?latex=%5Clog%282%29&bg=ffffff&fg=333333&s=0&c=20201002);
7) ![\\pi \\times \\phi](https://s0.wp.com/latex.php?latex=%5Cpi+%5Ctimes+%5Cphi&bg=ffffff&fg=333333&s=0&c=20201002).
...
curve produces fir-tree like patterns. The
![\\log(2)](https://s0.wp.com/latex.php?latex=%5Clog%282%29&bg=ffffff&fg=333333&s=0&c=20201002)
curve produces several ‘S’ shaped patterns. The ![\\pi \\times \\phi](https://s0.wp.com/latex.php?latex=%5Cpi+%5Ctimes+%5Cphi&bg=ffffff&fg=333333&s=0&c=20201002) produces a basic pattern of highly folded “beads” connected by unfolded linkers. Together they are organized into the path of multiple spiraling curves that resemble Johann Bernoulli’s clothoid which emerges in optics
(where it is called a Cornu spirals). When a beam from a distant source
of light encounters a slit of size comparable to its wavelength we get a typical diffraction pattern with a central peak of high intensity followed by increasingly damped peaks of much lower intensity on its flanks. Now, if the light source is close to the slit then the analysis of the diffraction patterns becomes very complicated. It is in such a case, where a nearby linear light source produces a cylindrical wave front, that this spiral curve can be used to predict the diffraction pattern.

Second, nearness of numbers does not necessarily translate into the similar pattern. We know that
![\\sqrt{10}](https://s0.wp.com/latex.php?latex=%5Csqrt%7B10%7D&bg=ffffff&fg=333333&s=0&c=20201002)
was used often in early Hindu mathematics as an approximation for
![\\pi](https://s0.wp.com/latex.php?latex=%5Cpi&bg=ffffff&fg=333333&s=0&c=20201002)
correct to one decimal place. However, this number produces a wandering curve that is not at all similar to that of
![\\pi](https://s0.wp.com/latex.php?latex=%5Cpi&bg=ffffff&fg=333333&s=0&c=20201002).
Then we see the famous approximation used by Ramanujan
![\\dfrac{355}{113}](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B355%7D%7B113%7D&bg=ffffff&fg=333333&s=0&c=20201002)
correct to six decimal places. It being a rational number does not produce a fractal pattern but a linear sequence of highly folded “beads” connected by a linker element. This resembles the unfolded nucleosome-DNA complex in archaea and eukaryotes. The real
![\\pi](https://s0.wp.com/latex.php?latex=%5Cpi&bg=ffffff&fg=333333&s=0&c=20201002)
in contrast has a highly folded bead similar to the former but the linker gradually curls making curve take an overall spiral form.
