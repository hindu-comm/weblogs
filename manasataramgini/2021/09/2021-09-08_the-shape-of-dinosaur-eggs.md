...
![y=\\pm\\dfrac{B}{2}\\sqrt{\\dfrac{L^{2}-4x^{2}}{L^{2}+8wx+4w^{2}}}](https://s0.wp.com/latex.php?latex=y%3D%5Cpm%5Cdfrac%7BB%7D%7B2%7D%5Csqrt%7B%5Cdfrac%7BL%5E%7B2%7D-4x%5E%7B2%7D%7D%7BL%5E%7B2%7D%2B8wx%2B4w%5E%7B2%7D%7D%7D&bg=ffffff&fg=333333&s=0&c=20201002)

Here,
![L](https://s0.wp.com/latex.php?latex=L&bg=ffffff&fg=333333&s=0&c=20201002)
is the major axis or length of the egg with its center placed at origin
![O=(0,0)](https://s0.wp.com/latex.php?latex=O%3D%280%2C0%29&bg=ffffff&fg=333333&s=0&c=20201002).
![B](https://s0.wp.com/latex.php?latex=B&bg=ffffff&fg=333333&s=0&c=20201002)
is the minor axis or maximal breadth of the egg.
...
and the point of intersection of the segments
![L](https://s0.wp.com/latex.php?latex=L&bg=ffffff&fg=333333&s=0&c=20201002)
and
![B](https://s0.wp.com/latex.php?latex=B&bg=ffffff&fg=333333&s=0&c=20201002).
By taking
![L=1](https://s0.wp.com/latex.php?latex=L%3D1&bg=ffffff&fg=333333&s=0&c=20201002)
this effectively yields a 2 parameter ![(B,
w)](https://s0.wp.com/latex.php?latex=%28B%2C+w%29&bg=ffffff&fg=333333&s=0&c=20201002)
shape curve, that accounts for more egg morphologies than the Maxwellian
trifocal oval: with
![L=1](https://s0.wp.com/latex.php?latex=L%3D1&bg=ffffff&fg=333333&s=0&c=20201002),
we obtain the circular ![(B=1;
w=0)](https://s0.wp.com/latex.php?latex=%28B%3D1%3B+w%3D0%29&bg=ffffff&fg=333333&s=0&c=20201002),
elliptical ![(0 \\le B \<1);
w=0)](https://s0.wp.com/latex.php?latex=%280+%5Cle+B+%3C1%29%3B+w%3D0%29&bg=ffffff&fg=333333&s=0&c=20201002)
and oval ![(B \\ne 1;
w>0)](https://s0.wp.com/latex.php?latex=%28B+%5Cne+1%3B+w%3E0%29&bg=ffffff&fg=333333&s=0&c=20201002)
shape classes of extant avian eggs. Moreover, its parameters are
entirely intuitive and can be measured easily from real specimens.
However, it does not account for the so-called pyriform class (common in
shorebirds) or the Mesozoic dinosaurian eggs like those of Tarbosaurus,
the caenagnathid Beibeilong, the troodontids, or the ceratopsian
Protoceratops.

![\\bullet](https://s0.wp.com/latex.php?latex=%5Cbullet&bg=ffffff&fg=333333&s=0&c=20201002)
Preston’s 4 parameter oval: Incited by D’arcy Thompson’s failure to give
a general equation for the shape of eggs, in the 1950s, Frank Preston,
a versatile English engineer (invented a glass-melting furnace and
device measure avian egg shapes), marksman and naturalist, derived the 4
parameter oval to describe the shape of all bird eggs. He used the
following logic: the most symmetric class is the circular class for
which one can easily write down the equation: ![y=\\pm
\\sqrt{1-x^2}](https://s0.wp.com/latex.php?latex=y%3D%5Cpm+%5Csqrt%7B1-x%5E2%7D&bg=ffffff&fg=333333&s=0&c=20201002).
By multiplying this by the parameter ![a \\le
1](https://s0.wp.com/latex.php?latex=a+%5Cle+1&bg=ffffff&fg=333333&s=0&c=20201002),
the aspect ratio (ratio of minor to major axis) of an ellipse, we get
the equation ![y= \\pm
a\\sqrt{1-x^2}](https://s0.wp.com/latex.php?latex=y%3D+%5Cpm+a%5Csqrt%7B1-x%5E2%7D&bg=ffffff&fg=333333&s=0&c=20201002),
which can account for both the circular and elliptical classes. Then
Preston accounted for the remaining classes using a polynomial function
![f(x)=1+bx+cx^2+dx^3](https://s0.wp.com/latex.php?latex=f%28x%29%3D1%2Bbx%2Bcx%5E2%2Bdx%5E3&bg=ffffff&fg=333333&s=0&c=20201002),
where ![-1 \\le b, c, d \\le
1](https://s0.wp.com/latex.php?latex=-1+%5Cle+b%2C+c%2C+d+%5Cle+1&bg=ffffff&fg=333333&s=0&c=20201002),
...
![\\bullet](https://s0.wp.com/latex.php?latex=%5Cbullet&bg=ffffff&fg=333333&s=0&c=20201002)
In light of the success of the Preston oval, we were a bit surprised
when we saw a recent work by Narushin et al. claiming to introduce a
universal formula for the egg shape. They acknowledge the success of
Preston’s work but state that the parameters in his equation are neither
intuitive nor readily determined. The former is indeed a potential
criticism; however, the latter is less of any issue with modern graphing
software, so long as one has good photographs. Hence, they decided to
start with Hügelschäffer’s formula and applied a series of modifications
to arrive at a complicated formula for a general oval:

![y= \\dfrac{B}{2}\\sqrt{ \\dfrac{L^{2}-4x^{2}}{L^{2}+8wx+4w^{2}}} (1- k
f(x))](https://s0.wp.com/latex.php?latex=y%3D+%5Cdfrac%7BB%7D%7B2%7D%5Csqrt%7B+%5Cdfrac%7BL%5E%7B2%7D-4x%5E%7B2%7D%7D%7BL%5E%7B2%7D%2B8wx%2B4w%5E%7B2%7D%7D%7D+%281-+k+f%28x%29%29&bg=ffffff&fg=333333&s=0&c=20201002)

![k =
\\dfrac{\\sqrt{\\dfrac{11}{2}L^{2}+11Lw+4w^{2}}\\left(\\sqrt{3}BL-2D\\sqrt{L^{2}+2wL+4w^{2}}\\right)}{\\sqrt{3}BL\\left(\\sqrt{\\dfrac{11L^{2}}{2}+11Lw+4w^{2}}-2\\sqrt{L^{2}+2wL+4w^{2}}\\right)}](https://s0.wp.com/latex.php?latex=k+%3D+%5Cdfrac%7B%5Csqrt%7B%5Cdfrac%7B11%7D%7B2%7DL%5E%7B2%7D%2B11Lw%2B4w%5E%7B2%7D%7D%5Cleft%28%5Csqrt%7B3%7DBL-2D%5Csqrt%7BL%5E%7B2%7D%2B2wL%2B4w%5E%7B2%7D%7D%5Cright%29%7D%7B%5Csqrt%7B3%7DBL%5Cleft%28%5Csqrt%7B%5Cdfrac%7B11L%5E%7B2%7D%7D%7B2%7D%2B11Lw%2B4w%5E%7B2%7D%7D-2%5Csqrt%7BL%5E%7B2%7D%2B2wL%2B4w%5E%7B2%7D%7D%5Cright%29%7D&bg=ffffff&fg=333333&s=0&c=20201002)

![f(x) =
1-\\sqrt{\\dfrac{L\\left(L^{2}+8wx+4w^{2}\\right)}{2\\left(L-2w\\right)x^{2}+\\left(L^{2}+8Lw-4w^{2}\\right)x+2Lw^{2}+L^{2}w+L^{3}}}](https://s0.wp.com/latex.php?latex=f%28x%29+%3D+1-%5Csqrt%7B%5Cdfrac%7BL%5Cleft%28L%5E%7B2%7D%2B8wx%2B4w%5E%7B2%7D%5Cright%29%7D%7B2%5Cleft%28L-2w%5Cright%29x%5E%7B2%7D%2B%5Cleft%28L%5E%7B2%7D%2B8Lw-4w%5E%7B2%7D%5Cright%29x%2B2Lw%5E%7B2%7D%2BL%5E%7B2%7Dw%2BL%5E%7B3%7D%7D%7D&bg=ffffff&fg=333333&s=0&c=20201002)

Here, as in Hügelschäffer’s equation,
![L](https://s0.wp.com/latex.php?latex=L&bg=ffffff&fg=333333&s=0&c=20201002)
is the major axis or length of the egg;
![B](https://s0.wp.com/latex.php?latex=B&bg=ffffff&fg=333333&s=0&c=20201002)
is its minor axis or greatest breadth;
![D](https://s0.wp.com/latex.php?latex=D&bg=ffffff&fg=333333&s=0&c=20201002)
is the breadth of the egg at the point halfway from the center at
![(0,0)](https://s0.wp.com/latex.php?latex=%280%2C0%29&bg=ffffff&fg=333333&s=0&c=20201002)
to the narrow end of the egg (Figure 3). However,
![w](https://s0.wp.com/latex.php?latex=w&bg=ffffff&fg=333333&s=0&c=20201002)
is not the same as in the Hügelschäffer equation but is defined as:

![w=\\dfrac{L-B}{2n}](https://s0.wp.com/latex.php?latex=w%3D%5Cdfrac%7BL-B%7D%7B2n%7D&bg=ffffff&fg=333333&s=0&c=20201002),
where
![n](https://s0.wp.com/latex.php?latex=n&bg=ffffff&fg=333333&s=0&c=20201002)
is a positive number.

[![](https://manasataramgini.files.wordpress.com/2021/09/egg_dinosaurs02.png?w=592&h=430)](https://manasataramgini.files.wordpress.com/2021/09/egg_dinosaurs02.png)The
...
The relative merits of this equation need to be compared to that of
Preston’s using real specimens. Unfortunately, this requires additional
work as Mahadevan and colleagues’ large dataset does not have all the
necessary measurements for such a comparison. They instead used the oval
of Baker, an attempt to duplicate Preston’s work, which significantly
falls short of the latter in terms of accuracy while providing a simple
2 parameter space. It is defined by the equation:

![y=\\pm
a\\left(1-x\\right)^{\\frac{1}{1+b}}\\left(1+x\\right)^{\\frac{b}{1+b}}](https://s0.wp.com/latex.php?latex=y%3D%5Cpm+a%5Cleft%281-x%5Cright%29%5E%7B%5Cfrac%7B1%7D%7B1%2Bb%7D%7D%5Cleft%281%2Bx%5Cright%29%5E%7B%5Cfrac%7Bb%7D%7B1%2Bb%7D%7D&bg=ffffff&fg=333333&s=0&c=20201002)

Here ![0 \\le a \\le
1](https://s0.wp.com/latex.php?latex=0+%5Cle+a+%5Cle+1&bg=ffffff&fg=333333&s=0&c=20201002)
is the aspect ratio of the ellipse as in Preston’s equation or the
equivalent of ![B \|
L=1](https://s0.wp.com/latex.php?latex=B+%7C+L%3D1&bg=ffffff&fg=333333&s=0&c=20201002)
in Hügelschäffer’s equation, while ![1 \\le b \\le
2](https://s0.wp.com/latex.php?latex=1+%5Cle+b+%5Cle+2&bg=ffffff&fg=333333&s=0&c=20201002)
is an asymmetry parameter similar to
![w](https://s0.wp.com/latex.php?latex=w&bg=ffffff&fg=333333&s=0&c=20201002)
in Hügelschäffer’s equation. This curve has 3 successively tangent lobes
with points of tangency at
...
For ![x \\le
-1](https://s0.wp.com/latex.php?latex=x+%5Cle+-1&bg=ffffff&fg=333333&s=0&c=20201002)
and ![x \\ge
1](https://s0.wp.com/latex.php?latex=x+%5Cge+1&bg=ffffff&fg=333333&s=0&c=20201002)
the two lobes have a divergent hyperbola-like form. For ![-1 \\le x \\le
1](https://s0.wp.com/latex.php?latex=-1+%5Cle+x+%5Cle+1&bg=ffffff&fg=333333&s=0&c=20201002),
the curve takes the form of the oval that approximates the shape of a
dinosaurian egg. When
![b=1](https://s0.wp.com/latex.php?latex=b%3D1&bg=ffffff&fg=333333&s=0&c=20201002),
the curve becomes an ellipse.

A biologist can easily conceive each of the parameters from Preston’s or
Narushin et al.’s curves as being controlled by a genetic factor, with
changes in it leading to a change in the parameter. Thus, one can easily
account for the diversity of egg morphologies observed among dinosaurs
through genetic changes. The parameter
![\\leftrightarrow](https://s0.wp.com/latex.php?latex=%5Cleftrightarrow&bg=ffffff&fg=333333&s=0&c=20201002)
gene mapping feeds directly into the question of what are the selective
forces acting on egg shape. Several of these have been proposed and
debated since Darwin. Irrespective of the correctness of some of these,
one key point emerging from the suggestions made by Birkhead is that the
ovoid morphology is a clear sign of a comprise solution resulting from
balancing selection. The compromises themselves might involve very
different factors. One such relates to spherical morphology having the
smallest surface area for a given volume. Hence, it is ideal for not
losing heat quickly. However, eggs also need to be externally warmed,
either by direct contact with the mother or exposure to solar or
geothermal heat (e.g., in titanosaurs). Here, a less spherical shape
would afford a greater surface area to allow quicker external heating.
Similarly, a hard-shelled egg would have the greatest strength against
external force if spherical. This would be selected for better
protection or bearing the weight of the brooding mother or insulating
material deposited atop it. On the other hand, it should also be easy
enough for the chick to break out. These opposing forces would lead to
compromise solutions in the form of deviations from circularity.
