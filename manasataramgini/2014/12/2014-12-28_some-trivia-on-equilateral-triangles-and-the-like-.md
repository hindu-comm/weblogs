...
three, power, speed or precision only at the expense of the other two.
Thus, the above relationship appears to represent the reality of
tradeoffs such as this often encountered in the real world.
...
On each of its sides erect an equilateral triangle; thus we have:
![\\triangle ABC', \\triangle AB'C, and \\triangle A'BC
](https://s0.wp.com/latex.php?latex=%5Ctriangle+ABC%27%2C+%5Ctriangle+AB%27C%2C+and+%5Ctriangle+A%27BC+&bg=ffffff&fg=9ACD32&s=1&c=20201002).
Now an interesting result is that if you join the centers of these three
...
](https://s0.wp.com/latex.php?latex=%5Ctriangle+PQR+&bg=ffffff&fg=9ACD32&s=1&c=20201002).
While fascinated by this figure early in life, we learned later that
this result and triangle bore the name of the famous French conqueror
himself. This configuration of triangles is a veritable mother-lode of
geometric results:
...
and the center of the Napoleon ![\\triangle PQR
](https://s0.wp.com/latex.php?latex=%5Ctriangle+PQR+&bg=ffffff&fg=9ACD32&s=1&c=20201002)
are the same.
...
to the respective opposite peaks A’, B’ and C’ of the three equilateral
triangles we had erected on the sides of ![\\triangle ABC
](https://s0.wp.com/latex.php?latex=%5Ctriangle+ABC+&bg=ffffff&fg=9ACD32&s=1&c=20201002)
we find that:  
1)![\\overline{AA'}\\cong \\overline{BB'}\\cong \\overline{CC'}
](https://s0.wp.com/latex.php?latex=%5Coverline%7BAA%27%7D%5Ccong+%5Coverline%7BBB%27%7D%5Ccong+%5Coverline%7BCC%27%7D+&bg=ffffff&fg=9ACD32&s=1&c=20201002)  
...
](https://s0.wp.com/latex.php?latex=AA%27%3DBB%27%3DCC%27%3D3.GP%3D3.GQ%3D3.GR+&bg=ffffff&fg=9ACD32&s=1&c=20201002)

• ![\\overline{AA'}, \\overline{BB'}, \\overline{CC'}
](https://s0.wp.com/latex.php?latex=%5Coverline%7BAA%27%7D%2C+%5Coverline%7BBB%27%7D%2C+%5Coverline%7BCC%27%7D+&bg=ffffff&fg=9ACD32&s=1&c=20201002)
are concurrent at a point termed the Fermat’s point F. This point has
interesting properties:  
1) All three vertices of ![\\triangle ABC
](https://s0.wp.com/latex.php?latex=%5Ctriangle+ABC+&bg=ffffff&fg=9ACD32&s=1&c=20201002)
are at an equal angular separation (![=2 \\pi/3 rad
](https://s0.wp.com/latex.php?latex=%3D2+%5Cpi%2F3+rad+&bg=ffffff&fg=9ACD32&s=1&c=20201002))
from each other at this point F.  
2) F is the minimum distance point, thus:  
![AF+BF+CF\< AX+BX+CX
](https://s0.wp.com/latex.php?latex=AF%2BBF%2BCF%3C+AX%2BBX%2BCX+&bg=ffffff&fg=9ACD32&s=1&c=20201002)
where X is a random point inside ![\\triangle ABC
](https://s0.wp.com/latex.php?latex=%5Ctriangle+ABC+&bg=ffffff&fg=9ACD32&s=1&c=20201002)

• If we draw lines passing through the vertices of the Napoleon
![\\triangle PQR
](https://s0.wp.com/latex.php?latex=%5Ctriangle+PQR+&bg=ffffff&fg=9ACD32&s=1&c=20201002)
to the corresponding peaks of the three equilateral triangles (A’, B’
and C’) then these lines are concurrent at a point O which is the
...
form hexagonal star. If we connect the opposite vertices of this
hexagonal star then the three lines ![\\overleftrightarrow {AP},
\\overleftrightarrow {BQ}, \\overleftrightarrow {CR}
](https://s0.wp.com/latex.php?latex=%5Coverleftrightarrow+%7BAP%7D%2C+%5Coverleftrightarrow+%7BBQ%7D%2C+%5Coverleftrightarrow+%7BCR%7D+&bg=ffffff&fg=9ACD32&s=1&c=20201002)
are concurrent at a point ![N\_{1}
](https://s0.wp.com/latex.php?latex=N_%7B1%7D+&bg=ffffff&fg=9ACD32&s=1&c=20201002),
the Napoleon point 1 (N in the figure; there is a second Napoleon point
![N\_{2}
](https://s0.wp.com/latex.php?latex=N_%7B2%7D+&bg=ffffff&fg=9ACD32&s=1&c=20201002)
formed by the inner Napoleon triangle obtained by erecting the
equilateral triangles internally on ![\\triangle ABC
](https://s0.wp.com/latex.php?latex=%5Ctriangle+ABC+&bg=ffffff&fg=9ACD32&s=1&c=20201002)).
Now in addition to the Napoleon centers we may also consider a few other
centers of interest:  
...
is the incenter of the medial triangle of ![\\triangle ABC
](https://s0.wp.com/latex.php?latex=%5Ctriangle+ABC+&bg=ffffff&fg=9ACD32&s=1&c=20201002),
i.e., the triangle formed by connecting the midpoints of its three
sides. If one draws the lines ![\\overleftrightarrow {AS\_{p}},
\\overleftrightarrow {BS\_{p}}, \\overleftrightarrow {CS\_{p}}
](https://s0.wp.com/latex.php?latex=%5Coverleftrightarrow+%7BAS_%7Bp%7D%7D%2C+%5Coverleftrightarrow+%7BBS_%7Bp%7D%7D%2C+%5Coverleftrightarrow+%7BCS_%7Bp%7D%7D+&bg=ffffff&fg=9ACD32&s=1&c=20201002),
known as the cleavers, then each of them cleaves the ![\\triangle ABC
](https://s0.wp.com/latex.php?latex=%5Ctriangle+ABC+&bg=ffffff&fg=9ACD32&s=1&c=20201002)‘s
perimeter into two equal halves. ![S\_{p}
](https://s0.wp.com/latex.php?latex=S_%7Bp%7D+&bg=ffffff&fg=9ACD32&s=1&c=20201002)
was apparently discovered by the eponymous German mathematician who
wrote a textbook that apparently inspired the scientist Einstein on his
