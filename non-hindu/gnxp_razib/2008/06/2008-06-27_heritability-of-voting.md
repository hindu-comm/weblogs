+++
title = "Heritability of voting"
full_title = "Heritability of voting"
date = "2008-06-27"
upstream_url = "https://www.gnxp.com/WordPress/2008/06/27/heritability-of-voting/"

+++
Source: [here](https://www.gnxp.com/WordPress/2008/06/27/heritability-of-voting/).

Heritability of voting

I just read an interesting new paper, [Genetic Variation in Political Participation](http://jhfowler.ucsd.edu/genetic_basis_of_political_cooperation.pdf):
...
![twinspolitics.jpg](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/twinspolitics.jpg?resize=500%2C215)![twinspolitics.jpg](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/twinspolitics.jpg?resize=500%2C215)
...
> The results of the ACE model suggest that **53% of the variance in > turnout behavior can be accounted for by additive genetic effects** > (*h²*). The 95% credible interval (C.I.) for the estimate is (10%, > 89%), indicating that we can reject the hypothesis that genes do not > contribute to variation in turnout. The ACE model also suggests that the environment is important, with the shared environment (*c²*) accounting for about 35% of the variance (C.I. 2%, 73%) and the unshared environment (*e²*) accounting for 12% (C.I. 3%, 26%)….

Here’s what the “ACE” model comes from:  
σ2_(P) = σ²_(A) + σ²_(C) + σ²_(E)  
COV_(MZ) = σ²_(A) + σ²_(C)  
COV_(DZ) = 1/2σ²_(A) + σ²_(C)  
![Galton-height-regress.jpg](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/Galton-height-regress.jpg?resize=250%2C226)![Galton-height-regress.jpg](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/Galton-height-regress.jpg?resize=250%2C226)If you’ve read my posts on quantitative genetics you know what all the symbols and scripts refer to. If you haven’t, just focus on the “A,” the [additive genetic variance](http://www.biochem.northwestern.edu/holmgren/Glossary/Definitions/Def-A/additive_genetic_variance.html). What’s additive genetic variance? It’s the variance that accounts for narrow sense variability. It’s the variation of genes within a population which accounts for variation of a trait when you exclude the dominance and epistatic components of variance. Get it? If not, just look at the chart to the left and the note the “line of best fit,” the additive genetic variation just describes the slope of that line when you regress offspring trait value on those of their parents. If it is a line of slope 1 that indicates that heritability is perfect, **and you can predict offspring trait value perfectly from that of the parent.** If the slope is 0, that means there is no predictive value and the trait value of the offspring is due to components of variance such as environment.  
...
Ultimately my own interest in this topic is the transition from behavior genetics to behavior genomics. For example, see [Heritability of the Ultimatum Game](https://www.gnxp.com/blog/2007/10/heritability-of-ultimatum-game.php) and [DRD4, politics & friendship](https://www.gnxp.com/blog/2008/06/drd4-politics-friendship.php) (same author). The main issue here is that it seems like that a large proportion of the above variance is due to QTLs of very small effect which are going to be hard to pick up. It isn’t as if there are “genes for voter turnout,” as it is it seems likely that that a host of genetically influenced upstream behavior propensities leads to whether you invest your marginal time in voting or not. So the genetic architecture of political variation might be elucidated more by focusing on its behavioral subcomponents.

### Related Posts:

- [Heritability of
  voting](https://www.gnxp.com/WordPress/2008/06/27/heritability-of-voting/) - [Political Behavior through the Lens of Behavior
  Genetics](https://www.gnxp.com/WordPress/2008/11/09/political-behavior-through-the-lens-of-behavior-genetics/) - [DRD4, politics &
  friendship](https://www.gnxp.com/WordPress/2008/06/11/drd4-politics-friendship/) - [Cooperation and
  heritability](https://www.gnxp.com/WordPress/2008/03/04/cooperation-and-heritability/) - [Most Reported Genetic Associations with General
  Intelligence…](https://www.gnxp.com/WordPress/2011/12/11/most-reported-genetic-associations-with-general-intelligence-are-probably-false-positives/) - [The white vote for Obama, by county &
  correlates](https://www.gnxp.com/WordPress/2009/11/28/the-white-vote-for-obama-by-county-correlates/)

### *Related*

[](https://www.addtoany.com/add_to/facebook?linkurl=https%3A%2F%2Fwww.gnxp.com%2FWordPress%2F2008%2F06%2F27%2Fheritability-of-voting%2F&linkname=Heritability%20of%20voting "Facebook")[](https://www.addtoany.com/add_to/twitter?linkurl=https%3A%2F%2Fwww.gnxp.com%2FWordPress%2F2008%2F06%2F27%2Fheritability-of-voting%2F&linkname=Heritability%20of%20voting "Twitter")[](https://www.addtoany.com/add_to/email?linkurl=https%3A%2F%2Fwww.gnxp.com%2FWordPress%2F2008%2F06%2F27%2Fheritability-of-voting%2F&linkname=Heritability%20of%20voting "Email")[](https://www.addtoany.com/share)

[Genetic Variation in Political Participation](http://jhfowler.ucsd.edu/genetic_basis_of_political_cooperation.pdf):

> The decision to vote has puzzled scholars for decades…**The results > show that a significant proportion of the variation in voting turnout > can be accounted for by genes.** We also replicate these results with > data from the National Longitudinal Study of Adolescent Health and > show that they extend to a broad class of acts of political participation. These are the first findings to suggest that humans exhibit genetic variation in their tendency to participate in political activities.

Additive genetic variance \~ 0.50. You can read the [whole paper](http://jhfowler.ucsd.edu/genetic_basis_of_political_cooperation.pdf), though I’ve [blogged it elsewhere](http://scienceblogs.com/gnxp/2008/06/heritability_of_voting.php).

### Related Posts:

- [Heritability of
  voting](https://www.gnxp.com/WordPress/2008/06/27/heritability-of-voting/) - [Political Behavior through the Lens of Behavior
  Genetics](https://www.gnxp.com/WordPress/2008/11/09/political-behavior-through-the-lens-of-behavior-genetics/) - [Cooperation and
  heritability](https://www.gnxp.com/WordPress/2008/03/04/cooperation-and-heritability/) - [Most Reported Genetic Associations with General
  Intelligence…](https://www.gnxp.com/WordPress/2011/12/11/most-reported-genetic-associations-with-general-intelligence-are-probably-false-positives/) - [DRD4, politics &
  friendship](https://www.gnxp.com/WordPress/2008/06/11/drd4-politics-friendship/) - [Development & genetic determinants of
  height](https://www.gnxp.com/WordPress/2009/03/06/development-genetic-determinants-of-height/)
