+++
title = "When sickliness is"
full_title = "When sickliness is manliness"
date = "2010-03-31"
upstream_url = "https://www.gnxp.com/WordPress/2010/03/31/when-sickliness-is-manliness/"

+++
Source: [here](https://www.gnxp.com/WordPress/2010/03/31/when-sickliness-is-manliness/).

When sickliness is manliness

[![ResearchBlogging.org](https://i0.wp.com/www.researchblogging.org/public/citation_icons/rb2_large_gray.png?w=640)![ResearchBlogging.org](https://i0.wp.com/www.researchblogging.org/public/citation_icons/rb2_large_gray.png?w=640)](http://www.researchblogging.org)[Below](http://blogs.discovermagazine.com/gnxp/2010/03/the-sexual-straightjacket/) I note that sex matters when it comes to evolution, specifically in the case of how sexual reproduction forces the bits of the genome to be passed back and forth across sexes. In fact, the origin of sex is arguably the most important evolutionary question after the origin of species, and it remains one of the most [active](http://blogs.discovermagazine.com/gnxp/2009/10/the-arcs-of-evolutionary-genetics-always-cross-back/) areas of research in evolutionary genetics. More specifically the existence of males, who do not bear offspring themselves but seem to be transient gene carriers is a major conundrum. But that’s not the main issue in this post. Let’s take the existence of males as a given. **How do sex differences play out in evolutionary terms shaping other phenotypes?** Consider [Bateman’s principle](https://en.wikipedia.org/wiki/Bateman's_principle):
...
Female ova are energetically more expensive, and scarcer, than male sperm. Additionally, in mammals and other live-bearing species the female invests more time and energy after the point of fertilization but before the young exhibit any modicum of organismic independence (the [seahorse](https://en.wikipedia.org/wiki/Seahorse#Reproduction) being the exception). And, often the female is the “primary caregiver” in the case of species where the offspring require more care after birth. The logic of Bateman’s principle is so obvious when its premises are stated that it easily leads to a proliferation of numerous inferences, and many data are “explained” by its operation (in [Mother Nature: Maternal Instincts and How They Shape the Human Species](https://www.amazon.com/exec/obidos/ASIN/0345408934/geneexpressio-20/) the biological anthroplogist Sarah Hrdy moots the complaint that the principle is applied rather too generously in the context of an important operationally monogamous primate, humans).

But the general behavioral point is rooted in realities of anatomy and life-history; in many [dioecious](https://en.wikipedia.org/wiki/Dioecious) species males and females exhibit a great deal of biological and behavioral dimorphism. But the direction and nature of dimorphism varies. Male gorillas and elephant seals are far larger than females of their kind, but among [raptors](https://www.blm.gov/id/st/en/fo/four_rivers/01/links/general_raptor_facts.html) females are larger. If evolution operated like Newtonian mechanics I assume we wouldn’t be theorizing about why species or sex existed at all, we’d all long ago have evolved toward perfectly adapted spherical cows floating in our own effluvium, a species which is a biosphere.

Going beyond what is skin deep, in humans it is often stated that males are less immunologically robust than females. Some argue that this is due to higher testosterone levels, which produce a weakened immune system. Amtoz Zahavi might argue that this is an illustration of the [‘handicap principle’](https://www.gnxp.com/MT2/archives/000846.html). Only very robust males who are genetically superior can ‘afford’ the weakened immune system which high testosterone produces, in addition to the various [secondary sexual characteristics](https://en.wikipedia.org/wiki/File:Arnold_Schwarzenegger_speech.jpg) beloved of film goers. Others would naturally suggest that male behavior is to blame. For example, perhaps males forage or wander about more, all the better to catch bugs, and they pay less attention to cleanliness.

But could there be a deeper evolutionary dynamic rooted in the differential behaviors implied from Bateman’s principle? A new paper in *The Proceedings of the Royal Society* explores this question with a mathematical model, [The evolution of sex-specific immune defences](http://rspb.royalsocietypublishing.org/content/early/2010/03/23/rspb.2010.0188.short?rss=1):  
...
![graphic-1](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/2010/03/graphic-1.gif?resize=307%2C69)![graphic-1](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/2010/03/graphic-1.gif?resize=307%2C69)
...
![graphic-3](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/2010/03/graphic-3.gif?resize=373%2C195)![graphic-3](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/2010/03/graphic-3.gif?resize=373%2C195)

**And these are the three models that they ran computations with**

![graph4](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/2010/03/graph4.png?resize=501%2C313)![graph4](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/2010/03/graph4.png?resize=501%2C313)
...
![symboltable](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/2010/03/symboltable.png?resize=469%2C610)![symboltable](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/2010/03/symboltable.png?resize=469%2C610)

If you really want to understand the methods and derivations, as well how the details of how they computa[e evolutionarily stable strategies](https://en.wikipedia.org/wiki/Evolutionarily_stable_strategy), you’ll have to go into the [supplements](http://rspb.royalsocietypublishing.org/content/early/2010/03/23/rspb.2010.0188/suppl/DC1). **Let’s just assume that their findings are valid based on their premises.**
...
![graphresistence](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/2010/03/graphresistence.png?resize=600%2C444)![graphresistence](https://i0.wp.com/blogs.discovermagazine.com/gnxp/files/2010/03/graphresistence.png?resize=600%2C444)
...
Restif, O., & Amos, W. (2010). The evolution of sex-specific immune defences Proceedings of the Royal Society B: Biological Sciences DOI: [10.1098/rspb.2010.0188](https://dx.doi.org/10.1098/rspb.2010.0188)

### Related Posts:

- [The sexual
  straightjacket](https://www.gnxp.com/WordPress/2010/03/30/the-sexual-straightjacket/) - [The Green Beard of
  Sex](https://www.gnxp.com/WordPress/2009/04/27/the-green-beard-of-sex/) - [Svante Paabo believes modern humans &
  Neandertals…](https://www.gnxp.com/WordPress/2009/10/26/svante-paabo-believes-modern-humans-neandertals-interbred/) - [The inevitability of sex chromosome
  degeneration](https://www.gnxp.com/WordPress/2014/02/09/the-inevitability-of-sex-chromosome-degeneration/) - [The evolving
...
[](https://www.addtoany.com/add_to/facebook?linkurl=https%3A%2F%2Fwww.gnxp.com%2FWordPress%2F2010%2F03%2F31%2Fwhen-sickliness-is-manliness%2F&linkname=When%20sickliness%20is%20manliness "Facebook")[](https://www.addtoany.com/add_to/twitter?linkurl=https%3A%2F%2Fwww.gnxp.com%2FWordPress%2F2010%2F03%2F31%2Fwhen-sickliness-is-manliness%2F&linkname=When%20sickliness%20is%20manliness "Twitter")[](https://www.addtoany.com/add_to/email?linkurl=https%3A%2F%2Fwww.gnxp.com%2FWordPress%2F2010%2F03%2F31%2Fwhen-sickliness-is-manliness%2F&linkname=When%20sickliness%20is%20manliness "Email")[](https://www.addtoany.com/share)
